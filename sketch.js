...
function setup() {
	...
	lBody=Bodies.rectangle(width/2-100,height-80,20,100,{isStatic:true});
	World.add(world,lBody);
	baseBody=Bodies.rectangle(width/2,height-50,200,20,{isStatic:true});
	World.add(world,baseBody);
	rBody=Bodies.rectangle(width/2+100,height-80,20,100,{isStatic:true});
